...
cv::Mat qDPC_loop(int16_t angle, Mat dpc, Mat transferFn)
{
...
int main(int argc, char** argv )
{
   ...
   */
   ...
   transFunction135.convertTo(transFunction135,CV_64FC1);
	...
	Mat ph_dpc = qDPC_loop(45,dpc,transFunction45);
   normalize(ph_dpc, ph_dpc, 0, 1, CV_MINMAX);
   //Mat result = qDPC_loop(45,dpc,transFunction45);
   

   namedWindow("DPC Image", WINDOW_NORMAL);
   imshow("DPC Image", dpc);
